...
echo '<a href="https://driveplyr.appspages.online/api/download.php?url=https://driveplyr.appspages.online/dashboard/getvideo.php?id='.$id.'"> <button class="btn btn-danger">Download</button></a>
                     ' ;}
    ?>
